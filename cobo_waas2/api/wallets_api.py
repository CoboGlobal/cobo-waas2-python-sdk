...
class WalletsApi:
    ...
    def list_account_balances(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The wallet ID.")],
        chain_id: Annotated[StrictStr, Field(description="The chain ID, which is the unique identifier of a blockchain. Currently, only the following account-based chains are supported: - `ETH`: Ethereum - `TRON`: TRON - `SOL`: Solana - `SETH`: Ethereum Sepolia Testnet - `TTRON`: TRON Testnet - `SOLDEV_SOL`: Solana Devnet ")],
        queries: Annotated[StrictStr, Field(description="A comma-separated list of balance queries. Each query is a token ID and a wallet address separated by a colon (:), in the format `{token_id}:{address}`. A maximum of 50 queries can be specified per request to ensure the URL length stays within standard web server limits (typically 8 KB).  You can retrieve the IDs of all the tokens you can use by calling [List enabled tokens](https://www.cobo.com/developers/v2/api-references/wallets/list-enabled-tokens).  Example: `ETH_USDT:0x1c53e3f2f8b59e5d6b6b6b6b6b6b6b6b6b6b6b6b,ETH:0x9bff46afe2b45ffdfd8a99d4990878d0a44a67b8` ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param wallet_id: The wallet ID. (required)
        :type wallet_id: str
        :param chain_id: The chain ID, which is the unique identifier of a blockchain. Currently, only the following account-based chains are supported: - `ETH`: Ethereum - `TRON`: TRON - `SOL`: Solana - `SETH`: Ethereum Sepolia Testnet - `TTRON`: TRON Testnet - `SOLDEV_SOL`: Solana Devnet  (required)
        :type chain_id: str
        ...
        _param = self._list_account_balances_serialize(
            wallet_id=wallet_id,
            chain_id=chain_id,
            queries=queries,
        )
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListAccountBalances200Response",
            '4XX': "ErrorResponse",
            '5XX': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def list_account_balances_with_http_info(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The wallet ID.")],
        chain_id: Annotated[StrictStr, Field(description="The chain ID, which is the unique identifier of a blockchain. Currently, only the following account-based chains are supported: - `ETH`: Ethereum - `TRON`: TRON - `SOL`: Solana - `SETH`: Ethereum Sepolia Testnet - `TTRON`: TRON Testnet - `SOLDEV_SOL`: Solana Devnet ")],
        queries: Annotated[StrictStr, Field(description="A comma-separated list of balance queries. Each query is a token ID and a wallet address separated by a colon (:), in the format `{token_id}:{address}`. A maximum of 50 queries can be specified per request to ensure the URL length stays within standard web server limits (typically 8 KB).  You can retrieve the IDs of all the tokens you can use by calling [List enabled tokens](https://www.cobo.com/developers/v2/api-references/wallets/list-enabled-tokens).  Example: `ETH_USDT:0x1c53e3f2f8b59e5d6b6b6b6b6b6b6b6b6b6b6b6b,ETH:0x9bff46afe2b45ffdfd8a99d4990878d0a44a67b8` ")],
    ...
    ) -> ApiResponse[ListAccountBalances200Response]:
        """List account balances
    ...
    @validate_call
    def list_account_balances_without_preload_content(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The wallet ID.")],
        chain_id: Annotated[StrictStr, Field(description="The chain ID, which is the unique identifier of a blockchain. Currently, only the following account-based chains are supported: - `ETH`: Ethereum - `TRON`: TRON - `SOL`: Solana - `SETH`: Ethereum Sepolia Testnet - `TTRON`: TRON Testnet - `SOLDEV_SOL`: Solana Devnet ")],
        queries: Annotated[StrictStr, Field(description="A comma-separated list of balance queries. Each query is a token ID and a wallet address separated by a colon (:), in the format `{token_id}:{address}`. A maximum of 50 queries can be specified per request to ensure the URL length stays within standard web server limits (typically 8 KB).  You can retrieve the IDs of all the tokens you can use by calling [List enabled tokens](https://www.cobo.com/developers/v2/api-references/wallets/list-enabled-tokens).  Example: `ETH_USDT:0x1c53e3f2f8b59e5d6b6b6b6b6b6b6b6b6b6b6b6b,ETH:0x9bff46afe2b45ffdfd8a99d4990878d0a44a67b8` ")],
    ...
    def _list_account_balances_serialize(
        self,
        wallet_id,
        chain_id,
        queries,
        ...
        if queries is not None:
            ...
            _query_params.append(('queries', queries))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/wallets/{wallet_id}/chains/{chain_id}/account/balances',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_enabled_tokens(
        ...
        :type token_ids: str
        :param token_addresses: A list of token contract addresses (Supports up to 500), separated by comma. Matching is case-insensitive, so you can pass either lowercase or checksum addresses. Because the same contract address may be deployed on multiple chains, this filter can return tokens across different chain IDs; combine it with `chain_ids` to narrow the result to a specific chain. Native tokens have no contract address and are excluded from the result.
        :type token_addresses: str
        :param limit: The maximum number of objects to return. The value range is [1, 500].
        :type limit: int
        :param before: A cursor indicating the position before the current page. This value is generated by Cobo and returned in the response. If you are paginating forward from the beginning, you do not need to provide it on the first request. When paginating backward (to the previous page), you should pass the before value returned from the last response. 
        :type before: str
    ...
    def _list_enabled_tokens_serialize(
        ...
        if token_addresses is not None:
            ...
            _query_params.append(('token_addresses', token_addresses))
    ...
    @validate_call
    def list_transaction_utxos(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The wallet ID.")],
        chain_id: Annotated[StrictStr, Field(description="The chain ID, which is the unique identifier of a blockchain. You can retrieve the IDs of all the chains you can use by calling [List enabled chains](https://www.cobo.com/developers/v2/api-references/wallets/list-enabled-chains).")],
        tx_hash: Annotated[StrictStr, Field(description="The transaction hash to filter UTXOs by.")],
        is_change: Annotated[Optional[StrictBool], Field(description="Filter UTXOs by whether they are change outputs.")] = None,
        vout_n: Annotated[Optional[StrictInt], Field(description="The output index of the UTXO to filter by.")] = None,
        ...
        :param chain_id: The chain ID, which is the unique identifier of a blockchain. You can retrieve the IDs of all the chains you can use by calling [List enabled chains](https://www.cobo.com/developers/v2/api-references/wallets/list-enabled-chains). (required)
        :type chain_id: str
        :param tx_hash: The transaction hash to filter UTXOs by. (required)
        :type tx_hash: str
        :param is_change: Filter UTXOs by whether they are change outputs.
        :type is_change: bool
        :param vout_n: The output index of the UTXO to filter by.
        :type vout_n: int
        ...
        _param = self._list_transaction_utxos_serialize(
            wallet_id=wallet_id,
            chain_id=chain_id,
            tx_hash=tx_hash,
            is_change=is_change,
    ...
    @validate_call
    def list_transaction_utxos_with_http_info(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The wallet ID.")],
        chain_id: Annotated[StrictStr, Field(description="The chain ID, which is the unique identifier of a blockchain. You can retrieve the IDs of all the chains you can use by calling [List enabled chains](https://www.cobo.com/developers/v2/api-references/wallets/list-enabled-chains).")],
        tx_hash: Annotated[StrictStr, Field(description="The transaction hash to filter UTXOs by.")],
    ...
    @validate_call
    def list_transaction_utxos_without_preload_content(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The wallet ID.")],
        chain_id: Annotated[StrictStr, Field(description="The chain ID, which is the unique identifier of a blockchain. You can retrieve the IDs of all the chains you can use by calling [List enabled chains](https://www.cobo.com/developers/v2/api-references/wallets/list-enabled-chains).")],
        tx_hash: Annotated[StrictStr, Field(description="The transaction hash to filter UTXOs by.")],
    ...
    def _list_transaction_utxos_serialize(
        self,
        wallet_id,
        chain_id,
        tx_hash,
        ...
        if is_change is not None:
            ...
            _query_params.append(('is_change', is_change))
            
        if vout_n is not None:
            
            _query_params.append(('vout_n', vout_n))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/wallets/{wallet_id}/transaction_utxos',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
