...
class PaymentApi:
    ...
    def get_merchant_kyc(
        ...
        _param = self._get_merchant_kyc_serialize(
            merchant_id=merchant_id,
        )

        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MerchantKycSubmission",
            '4XX': "ErrorResponse",
            '5XX': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_merchant_kyc_with_http_info(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The merchant ID.")],
        _request_timeout: Union[
            None,
    ...
    ) -> ApiResponse[MerchantKycSubmission]:
        """Get merchant KYC
    ...
    @validate_call
    def get_merchant_kyc_without_preload_content(
        self,
        merchant_id: Annotated[StrictStr, Field(description="The merchant ID.")],
        _request_timeout: Union[
            None,
    ...
    def _get_merchant_kyc_serialize(
        self,
        merchant_id,
    ) -> RequestSerialized:
        _path_params: Dict[str, str] = {}
    ...
    def list_balance_changes(
        self,
        source_account: Annotated[StrictStr, Field(description="The source account for which to retrieve balance changes. - If the source account is a merchant account, provide the merchant's ID (e.g., \"M1001\"). - If the source account is the developer account, use the string `\"developer\"`. ")],
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of objects to return. For most operations, the value range is [1, 50].")] = None,
        before: Annotated[Optional[StrictStr], Field(description="A cursor indicating the position before the current page. This value is generated by Cobo and returned in the response. If you are paginating forward from the beginning, you do not need to provide it on the first request. When paginating backward (to the previous page), you should pass the before value returned from the last response. ")] = None,
        after: Annotated[Optional[StrictStr], Field(description="A cursor indicating the position after the current page. This value is generated by Cobo and returned in the response. You do not need to provide it on the first request. When paginating forward (to the next page), you should pass the after value returned from the last response. ")] = None,
        token_id: Annotated[Optional[StrictStr], Field(description="The token ID used to filter balance changes. For a complete list of supported tokens, see [Cobo Payments Guide](https://www.cobo.com/payments/en/guides/overview). ")] = None,
        flow_direction: Annotated[Optional[PaymentBalanceFlowDirection], Field(description="The direction of the balance change relative to the source account. Possible values include: - `in`: Funds flow into the source account. - `out`: Funds flow out of the source account. ")] = None,
        min_created_timestamp: Annotated[Optional[StrictInt], Field(description="The minimum creation time of balance changes, represented as a UNIX timestamp in seconds. Balance changes created on or after this time are returned.")] = None,
        max_created_timestamp: Annotated[Optional[StrictInt], Field(description="The maximum creation time of balance changes, represented as a UNIX timestamp in seconds. Balance changes created on or before this time are returned.")] = None,
        source_type: Annotated[Optional[PaymentBalanceChangeSourceType], Field(description="The source type used to filter balance changes. Possible values include: - `Init`: Balance change caused by initialization. - `OrderIn`: Balance change from an order-in payment. - `LatePayment`: Balance change from a late payment. - `TopUp`: Balance change from a top-up. - `UnexceptedIn`: Balance change from an unexpected incoming payment. - `RefundOut`: Balance change from a refund payout. - `Payout`: Balance change from a payout. - `UnexceptedOut`: Balance change from an unexpected outgoing payment. - `Allocation`: Balance change from an allocation. - `SettlementNetwork`: Balance change from the settlement network. - `BulkSend`: Balance change from a bulk send.  <Note>When specifying `source_id`, you must also specify `source_type`.</Note> ")] = None,
        source_id: Annotated[Optional[StrictStr], Field(description="The source ID used to filter balance changes.  <Note>When specifying `source_id`, you must also specify `source_type`.</Note> ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param source_account: The source account for which to retrieve balance changes. - If the source account is a merchant account, provide the merchant's ID (e.g., \"M1001\"). - If the source account is the developer account, use the string `\"developer\"`.  (required)
        :type source_account: str
        :param limit: The maximum number of objects to return. For most operations, the value range is [1, 50].
        :type limit: int
        :param before: A cursor indicating the position before the current page. This value is generated by Cobo and returned in the response. If you are paginating forward from the beginning, you do not need to provide it on the first request. When paginating backward (to the previous page), you should pass the before value returned from the last response. 
        ...
        :param after: A cursor indicating the position after the current page. This value is generated by Cobo and returned in the response. You do not need to provide it on the first request. When paginating forward (to the next page), you should pass the after value returned from the last response. 
        :type after: str
        :param token_id: The token ID used to filter balance changes. For a complete list of supported tokens, see [Cobo Payments Guide](https://www.cobo.com/payments/en/guides/overview). 
        :type token_id: str
        :param flow_direction: The direction of the balance change relative to the source account. Possible values include: - `in`: Funds flow into the source account. - `out`: Funds flow out of the source account. 
        :type flow_direction: PaymentBalanceFlowDirection
        :param min_created_timestamp: The minimum creation time of balance changes, represented as a UNIX timestamp in seconds. Balance changes created on or after this time are returned.
        :type min_created_timestamp: int
        :param max_created_timestamp: The maximum creation time of balance changes, represented as a UNIX timestamp in seconds. Balance changes created on or before this time are returned.
        :type max_created_timestamp: int
        :param source_type: The source type used to filter balance changes. Possible values include: - `Init`: Balance change caused by initialization. - `OrderIn`: Balance change from an order-in payment. - `LatePayment`: Balance change from a late payment. - `TopUp`: Balance change from a top-up. - `UnexceptedIn`: Balance change from an unexpected incoming payment. - `RefundOut`: Balance change from a refund payout. - `Payout`: Balance change from a payout. - `UnexceptedOut`: Balance change from an unexpected outgoing payment. - `Allocation`: Balance change from an allocation. - `SettlementNetwork`: Balance change from the settlement network. - `BulkSend`: Balance change from a bulk send.  <Note>When specifying `source_id`, you must also specify `source_type`.</Note> 
        :type source_type: PaymentBalanceChangeSourceType
        :param source_id: The source ID used to filter balance changes.  <Note>When specifying `source_id`, you must also specify `source_type`.</Note> 
        :type source_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_balance_changes_serialize(
            source_account=source_account,
            limit=limit,
            before=before,
            after=after,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaymentBalanceChangeResponse",
            '4XX': "ErrorResponse",
            '5XX': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def list_balance_changes_with_http_info(
        self,
        source_account: Annotated[StrictStr, Field(description="The source account for which to retrieve balance changes. - If the source account is a merchant account, provide the merchant's ID (e.g., \"M1001\"). - If the source account is the developer account, use the string `\"developer\"`. ")],
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of objects to return. For most operations, the value range is [1, 50].")] = None,
        before: Annotated[Optional[StrictStr], Field(description="A cursor indicating the position before the current page. This value is generated by Cobo and returned in the response. If you are paginating forward from the beginning, you do not need to provide it on the first request. When paginating backward (to the previous page), you should pass the before value returned from the last response. ")] = None,
    ...
    ) -> ApiResponse[PaymentBalanceChangeResponse]:
        """List balance changes
    ...
    @validate_call
    def list_balance_changes_without_preload_content(
        self,
        source_account: Annotated[StrictStr, Field(description="The source account for which to retrieve balance changes. - If the source account is a merchant account, provide the merchant's ID (e.g., \"M1001\"). - If the source account is the developer account, use the string `\"developer\"`. ")],
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of objects to return. For most operations, the value range is [1, 50].")] = None,
        before: Annotated[Optional[StrictStr], Field(description="A cursor indicating the position before the current page. This value is generated by Cobo and returned in the response. If you are paginating forward from the beginning, you do not need to provide it on the first request. When paginating backward (to the previous page), you should pass the before value returned from the last response. ")] = None,
    ...
    def _list_balance_changes_serialize(
        self,
        source_account,
        limit,
        before,
        ...
        if flow_direction is not None:
            ...
            _query_params.append(('flow_direction', flow_direction.value))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payments/balance_changes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    ) -> ApiResponse[ListBulkSends200Response]:
        """List bulk sends
    ...
    def submit_merchant_kyc(
        ...
        _param = self._submit_merchant_kyc_serialize(
            merchant_id=merchant_id,
            submit_merchant_kyc=submit_merchant_kyc,
        )
    ...
    def _submit_merchant_kyc_serialize(
        self,
        merchant_id,
        submit_merchant_kyc,
    ) -> RequestSerialized:
        ...
        # process the form parameters
        # process the body parameter
        if submit_merchant_kyc is not None:
            _body_params = submit_merchant_kyc
    ...
    @validate_call
    def upload_payment_file_with_http_info(
        self,
        file: Annotated[Union[StrictBytes, StrictStr], Field(description="The file to upload.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def upload_payment_file_without_preload_content(
        self,
        file: Annotated[Union[StrictBytes, StrictStr], Field(description="The file to upload.")],
        _request_timeout: Union[
            None,
    ...
    def _upload_payment_file_serialize(
        self,
        file,
    ) -> RequestSerialized:
        _path_params: Dict[str, str] = {}
