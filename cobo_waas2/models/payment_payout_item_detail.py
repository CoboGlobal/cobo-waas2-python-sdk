...
class PaymentPayoutItemDetail(BaseModel):
    ...
    merchant_id: Optional[StrictStr] = Field(default=None, description="The Merchant ID associated with this payout.")
    ...
    __properties: ClassVar[List[str]] = ["payout_item_id", "payout_id", "token_id", "chain_id", "merchant_id", "amount", "status", "transactions", "created_timestamp", "updated_timestamp", "crypto_address_id", "crypto_address", "commission_fee", "bridging_fee"]
