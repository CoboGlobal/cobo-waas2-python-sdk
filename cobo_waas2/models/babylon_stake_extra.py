...
class BabylonStakeExtra(BaseModel):
    ...
    finality_provider_public_keys: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, description="The public keys of the finality providers(each key for a BSN chain).")
