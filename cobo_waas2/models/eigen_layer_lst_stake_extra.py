...
class EigenLayerLstStakeExtra(BaseModel):
    """
    EigenLayerLstStakeExtra
    """  # noqa: E501
    pool_type: StakingPoolType
    operator: Optional[StrictStr] = Field(default=None, description="The operator address.")
    __properties: ClassVar[List[str]] = ["pool_type", "operator"]
