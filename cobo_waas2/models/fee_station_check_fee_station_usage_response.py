...
class FeeStationCheckFeeStationUsageResponse(BaseModel):
    ...
    is_fee_station_applicable: StrictBool = Field(description="Indicates whether the fee station is applied for this transfer request.")
    is_balance_sufficient: StrictBool = Field(description="If the fee station is used, indicates whether its balance is sufficient to cover the required gas fee.")
    balance: StrictStr = Field(description="The current token balance available in the fee station.")
    total_fee_amount: StrictStr = Field(description="The total gas amount required for this transfer request.")
    is_sponsor_applicable: StrictBool = Field(description="Indicates whether USDT (U) sponsorship is applied when the fee station balance is insufficient.")
