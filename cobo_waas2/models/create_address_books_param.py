...
class CreateAddressBooksParam(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in address_books (list)
        _items = []
        if self.address_books:
            for _item in self.address_books:
                if _item:
                    _items.append(_item.to_dict())
            _dict['address_books'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address_books": [CreateAddressBookParam.from_dict(_item) for _item in obj["address_books"]] if obj.get("address_books") is not None else None
        })
        return _obj
