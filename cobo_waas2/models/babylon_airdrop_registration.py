...
class BabylonAirdropRegistration(BaseModel):
    ...
    """  # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier for tracking the airdrop registrgtiontration")
    ...
    airdrop_amount: Optional[StrictStr] = Field(default=None, description="Actual airdrop amount being claimed")
    error_message: Optional[StrictStr] = Field(default=None, description="Detailed error message if failed")
