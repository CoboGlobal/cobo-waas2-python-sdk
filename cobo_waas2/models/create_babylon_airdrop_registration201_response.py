...
class CreateBabylonAirdropRegistration201Response(BaseModel):
    """
    CreateBabylonAirdropRegistration201Response
    """  # noqa: E501
    registration_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for tracking the airdrop registration request")
