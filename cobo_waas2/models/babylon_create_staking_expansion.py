...
class BabylonCreateStakingExpansion(BaseModel):
    """
    The staking expansion information specific to the Babylon protocol.
    """  # noqa: E501
    staking_id: StrictStr = Field(description="The ID of the Phase-2 BTC staking position.")
    finality_provider_public_keys: List[Annotated[str, Field(strict=True)]] = Field(description="The public keys of the finality providers(each key for a BSN chain).")
    ...
    __properties: ClassVar[List[str]] = ["staking_id", "finality_provider_public_keys", "request_id", "fee"]
