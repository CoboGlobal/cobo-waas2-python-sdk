...
class SubmitKytScreeningsDecisionsBody(BaseModel):
    """
    The KYT screening decision submission containing transaction ID and compliance determination result.
    """  # noqa: E501
    transaction_id: StrictStr = Field(description="The UUID of the transaction for KYT result submission. This identifies the specific transaction that the external KYT result applies to.")
    result: KytScreeningsDecisionsType
    __properties: ClassVar[List[str]] = ["transaction_id", "result"]
