...
class ListAddressVerifications200Response(BaseModel):
    """
    Paginated list of address verification records.
    """  # noqa: E501
    data: List[AddressVerification] = Field(description="The page of address verification records.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AddressVerification.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
