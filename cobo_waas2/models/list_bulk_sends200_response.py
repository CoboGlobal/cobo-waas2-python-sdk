...
class ListBulkSends200Response(BaseModel):
    """
    ListBulkSends200Response
    """  # noqa: E501
    data: Optional[List[PaymentBulkSend]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PaymentBulkSend.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
