...
class PaymentPayoutItem(BaseModel):
    ...
    merchant_id: Optional[StrictStr] = Field(default=None, description="The Merchant ID associated with this payout item.")
    ...
    __properties: ClassVar[List[str]] = ["payout_item_id", "payout_id", "token_id", "chain_id", "amount", "status", "merchant_id", "transactions", "created_timestamp", "updated_timestamp", "crypto_address_id", "crypto_address", "commission_fee", "bridging_fee"]
