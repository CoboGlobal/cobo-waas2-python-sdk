...
class Activity(BaseModel):
    ...
    """  # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique id of the activity.")
    initiator: Optional[StrictStr] = Field(default=None, description="The initiator of the activity.")
    type: Optional[ActivityType] = None
    wallet_id: Optional[StrictStr] = Field(default=None, description="The id of the wallet to stake.")
    address: Optional[StrictStr] = Field(default=None, description="The staker wallet address.")
    pool_id: StrictStr = Field(description="The id of the staking pool.")
    token_id: StrictStr = Field(description="The id of the token.")
    staking_id: Optional[StrictStr] = Field(default=None, description="The id of the related staking.")
    amount: StrictStr = Field(description="The amount of the activity.")
    transaction_ids: Optional[List[StrictStr]] = Field(default=None, description="The related txs of the activity.")
    ...
    __properties: ClassVar[List[str]] = ["id", "initiator", "type", "wallet_id", "address", "pool_id", "token_id", "staking_id", "amount", "transaction_ids", "timeline", "fee", "status", "created_timestamp", "updated_timestamp"]
