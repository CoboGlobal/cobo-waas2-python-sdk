...
class CancelSatoshiTestChallengeRequest(BaseModel):
    """
    Request body for cancelling a Satoshi Test challenge that is in `PREPARE` or `PENDING` status.
    """  # noqa: E501
    challenge_id: StrictStr = Field(description="The challenge ID to cancel.")
    __properties: ClassVar[List[str]] = ["challenge_id"]
