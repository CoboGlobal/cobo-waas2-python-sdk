...
class ComplianceKyaScreeningsUpdateEventData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["data_type", "screening_id", "address", "chain_id", "status", "created_timestamp", "updated_timestamp"]
