...
class PaymentCreateSubscriptionAction(BaseModel):
    """
    PaymentCreateSubscriptionAction
    """  # noqa: E501
    request_id: StrictStr = Field(description="The subscription action request id.")
    plan_id: StrictStr = Field(description="The subscription plan id in cobo.")
    merchant_id: StrictStr = Field(description="The merchant id in cobo.")
    data: Optional[PaymentSubscriptionActionData] = None
    __properties: ClassVar[List[str]] = ["request_id", "plan_id", "merchant_id", "data"]
