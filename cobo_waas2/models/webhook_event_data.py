...
class WebhookEventData(BaseModel):
    ...
    # data type: PaymentBankWithdrawalEvent
    oneof_schema_17_validator: Optional[PaymentBankWithdrawalEvent] = None
    # data type: PaymentBulkSendEvent
    oneof_schema_18_validator: Optional[PaymentBulkSendEvent] = None
    # data type: PaymentBulkSendItemEvent
    oneof_schema_19_validator: Optional[PaymentBulkSendItemEvent] = None
    # data type: PaymentAccountBalanceUpdateEventData
    oneof_schema_20_validator: Optional[PaymentAccountBalanceUpdateEventData] = None
    # data type: ComplianceDispositionUpdateEventData
    oneof_schema_21_validator: Optional[ComplianceDispositionUpdateEventData] = None
    # data type: ComplianceKytScreeningsUpdateEventData
    oneof_schema_22_validator: Optional[ComplianceKytScreeningsUpdateEventData] = None
    # data type: ComplianceKyaScreeningsUpdateEventData
    oneof_schema_23_validator: Optional[ComplianceKyaScreeningsUpdateEventData] = None
    # data type: OrganizationEventData
    oneof_schema_24_validator: Optional[OrganizationEventData] = None
    # data type: FiatTransactionEventData
    oneof_schema_25_validator: Optional[FiatTransactionEventData] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, PaymentPayoutEvent):
            ...
            match += 1
        # validate data type: PaymentBankWithdrawalEvent
        if not isinstance(v, PaymentBankWithdrawalEvent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PaymentBankWithdrawalEvent`")
        else:
            match += 1
        ...
        if not isinstance(v, PaymentBulkSendEvent):
            ...
            match += 1
        # validate data type: PaymentBulkSendItemEvent
        if not isinstance(v, PaymentBulkSendItemEvent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PaymentBulkSendItemEvent`")
        else:
            match += 1
        # validate data type: PaymentAccountBalanceUpdateEventData
        if not isinstance(v, PaymentAccountBalanceUpdateEventData):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PaymentAccountBalanceUpdateEventData`")
        else:
            match += 1
        ...
        if not isinstance(v, ComplianceKyaScreeningsUpdateEventData):
            ...
            match += 1
        # validate data type: OrganizationEventData
        if not isinstance(v, OrganizationEventData):
            error_messages.append(f"Error! Input type `{type(v)}` is not `OrganizationEventData`")
        else:
            match += 1
        # validate data type: FiatTransactionEventData
        if not isinstance(v, FiatTransactionEventData):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FiatTransactionEventData`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # check if data type is `FiatTransactionEventData`
        if _data_type == "FiatTransaction":
            instance.actual_instance = FiatTransactionEventData.from_json(json_str)
            return instance
        ...
        # check if data type is `OrganizationEventData`
        if _data_type == "Organization":
            instance.actual_instance = OrganizationEventData.from_json(json_str)
            return instance

        # check if data type is `PaymentAccountBalanceUpdateEventData`
        if _data_type == "PaymentAccountBalanceUpdate":
            instance.actual_instance = PaymentAccountBalanceUpdateEventData.from_json(json_str)
            return instance
        ...
        # check if data type is `PaymentBankWithdrawalEvent`
        if _data_type == "PaymentBankWithdrawal":
            instance.actual_instance = PaymentBankWithdrawalEvent.from_json(json_str)
            return instance
        ...
        # check if data type is `PaymentBulkSendItemEvent`
        if _data_type == "PaymentBulkSendItem":
            instance.actual_instance = PaymentBulkSendItemEvent.from_json(json_str)
            return instance
        ...
        # check if data type is `FiatTransactionEventData`
        if _data_type == "FiatTransactionEventData":
            instance.actual_instance = FiatTransactionEventData.from_json(json_str)
            return instance
        ...
        # check if data type is `OrganizationEventData`
        if _data_type == "OrganizationEventData":
            instance.actual_instance = OrganizationEventData.from_json(json_str)
            return instance

        # check if data type is `PaymentAccountBalanceUpdateEventData`
        if _data_type == "PaymentAccountBalanceUpdateEventData":
            instance.actual_instance = PaymentAccountBalanceUpdateEventData.from_json(json_str)
            return instance
        ...
        # check if data type is `PaymentBankWithdrawalEvent`
        if _data_type == "PaymentBankWithdrawalEvent":
            instance.actual_instance = PaymentBankWithdrawalEvent.from_json(json_str)
            return instance
        ...
        # check if data type is `PaymentBulkSendItemEvent`
        if _data_type == "PaymentBulkSendItemEvent":
            instance.actual_instance = PaymentBulkSendItemEvent.from_json(json_str)
            return instance
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into PaymentBankWithdrawalEvent
        try:
            instance.actual_instance = PaymentBankWithdrawalEvent.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into PaymentBulkSendItemEvent
        try:
            instance.actual_instance = PaymentBulkSendItemEvent.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into PaymentAccountBalanceUpdateEventData
        try:
            instance.actual_instance = PaymentAccountBalanceUpdateEventData.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into OrganizationEventData
        try:
            instance.actual_instance = OrganizationEventData.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into FiatTransactionEventData
        try:
            instance.actual_instance = FiatTransactionEventData.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
