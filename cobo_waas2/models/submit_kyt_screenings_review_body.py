...
class SubmitKytScreeningsReviewBody(BaseModel):
    ...
    """  # noqa: E501
    transaction_id: StrictStr = Field(description="The UUID of the transaction for external KYT review. This identifies the transaction that requires external compliance review.")
