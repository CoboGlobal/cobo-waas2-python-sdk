...
class ListKeyShareHolderGroups200Response(BaseModel):
    """
    ListKeyShareHolderGroups200Response
    """  # noqa: E501
    data: Optional[List[KeyShareHolderGroup]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [KeyShareHolderGroup.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
