...
class TransactionTronContractDestination(BaseModel):
    """
    ...
    value: Optional[StrictStr] = Field(default=None, description="The transfer amount. For example, if you trade 1.5 TRON, then the value is `1.5`. ")
