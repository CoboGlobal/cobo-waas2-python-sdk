...
class PaymentBalanceChangeResponse(BaseModel):
    """
    The response containing balance changes and pagination information.
    """  # noqa: E501
    data: Optional[List[PaymentBalanceChange]] = Field(default=None, description="The list of balance changes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PaymentBalanceChange.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
