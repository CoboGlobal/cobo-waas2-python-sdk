...
class EvmLegacyFeeRate(BaseModel):
    """
    ...
    slow: Optional[EvmLegacyFeeBasePrice] = None
    recommended: EvmLegacyFeeBasePrice
    fast: Optional[EvmLegacyFeeBasePrice] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "slow": EvmLegacyFeeBasePrice.from_dict(obj["slow"]) if obj.get("slow") is not None else None,
            "recommended": EvmLegacyFeeBasePrice.from_dict(obj["recommended"]) if obj.get("recommended") is not None else None,
            "fast": EvmLegacyFeeBasePrice.from_dict(obj["fast"]) if obj.get("fast") is not None else None
        })
        return _obj
