...
class PaymentPayoutEvent(BaseModel):
    ...
    source_type: Optional[PaymentSourceType] = None
    ...
    __properties: ClassVar[List[str]] = ["data_type", "payout_id", "request_id", "status", "payout_item_details", "created_timestamp", "updated_timestamp", "initiator", "payout_channel", "source_type", "currency", "actual_payout_amount", "bank_account"]
