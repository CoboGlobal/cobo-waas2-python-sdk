...
class PaymentSubscriptionActionDetail(BaseModel):
    """
    ...
    subscription: Optional[PaymentSubscription] = None
    transactions: Optional[List[Transaction]] = Field(default=None, description="An array of subscription transactions.")
    __properties: ClassVar[List[str]] = ["request_id", "action_id", "plan_id", "subscription_id", "merchant_id", "merchant_address", "data", "transaction_ids", "status", "created_timestamp", "updated_timestamp", "subscription", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscription": PaymentSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None,
