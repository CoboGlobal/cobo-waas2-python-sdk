...
class SafeTxDecodedData(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parameters": [SafeTxDecodedDataParameters.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None
        })
        return _obj

from cobo_waas2.models.safe_tx_decoded_data_parameters import SafeTxDecodedDataParameters
# TODO: Rewrite to not use raise_errors
SafeTxDecodedData.model_rebuild(raise_errors=False)
