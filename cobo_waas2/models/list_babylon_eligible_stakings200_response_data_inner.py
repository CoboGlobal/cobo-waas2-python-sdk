...
class ListBabylonEligibleStakings200ResponseDataInner(BaseModel):
    ...
    """  # noqa: E501
    staking_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the staking position")
    btc_address: Optional[StakingSource] = None
    babylon_address: Optional[StakingSource] = None
    staked_amount: Optional[StrictStr] = Field(default=None, description="Current staked amount in BTC")
