...
class PaymentPayoutDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["payout_id", "request_id", "status", "payout_item_details", "created_timestamp", "updated_timestamp", "initiator", "payout_channel", "source_type", "currency", "actual_payout_amount", "bank_account"]
