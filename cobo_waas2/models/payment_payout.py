...
class PaymentPayout(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["payout_id", "request_id", "payout_channel", "source_type", "payout_items", "status", "created_timestamp", "updated_timestamp", "initiator", "currency", "actual_payout_amount", "bank_account"]
