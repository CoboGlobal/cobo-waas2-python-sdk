...
class PaymentSubscribeAndChargeSubscriptionActionData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action_type", "subscription_id", "charge_amount", "signature", "deadline"]
