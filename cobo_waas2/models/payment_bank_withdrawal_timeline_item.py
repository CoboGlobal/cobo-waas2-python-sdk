...
class PaymentBankWithdrawalTimelineItem(BaseModel):
    """
    PaymentBankWithdrawalTimelineItem
    """  # noqa: E501
    status: PaymentBankWithdrawalStatus
    timestamp: StrictInt = Field(description="The time when the bank withdrawal entered this status, represented as a UNIX timestamp in seconds.")
