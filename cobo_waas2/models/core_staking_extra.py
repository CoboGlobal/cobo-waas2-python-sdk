...
class CoreStakingExtra(BaseModel):
    ...
    staker_address: StrictStr = Field(description="The staker bitcoin address.")
    validator_address: StrictStr = Field(description="The validator evm address.")
    reward_address: StrictStr = Field(description="The reward evm address.")
