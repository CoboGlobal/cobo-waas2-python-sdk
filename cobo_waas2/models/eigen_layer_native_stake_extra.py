...
class EigenLayerNativeStakeExtra(BaseModel):
    """
    EigenLayerNativeStakeExtra
    """  # noqa: E501
    pool_type: StakingPoolType
    fee_recipient: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The fee recipient address, if not provided the staker address will be used.")
    __properties: ClassVar[List[str]] = ["pool_type", "fee_recipient"]
