...
class TransactionApprover(BaseModel):
    """
    The approver data for transaction.
    """  # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The approver name of the transaction.")
    status: Optional[StrictStr] = Field(default=None, description="The approval status.")
