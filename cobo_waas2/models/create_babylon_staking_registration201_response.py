...
class CreateBabylonStakingRegistration201Response(BaseModel):
    """
    CreateBabylonStakingRegistration201Response
    """  # noqa: E501
    registration_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for tracking the staking registration request")
