...
class AmountDetailsInner(BaseModel):
    """
    AmountDetailsInner
    """  # noqa: E501
    status: AmountStatus
    amount: StrictStr = Field(description="The staking amount.")
    activity_id: Optional[StrictStr] = Field(default=None, description="The related staking activity ID.")
    __properties: ClassVar[List[str]] = ["status", "amount", "activity_id"]
