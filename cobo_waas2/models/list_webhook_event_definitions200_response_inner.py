...
class ListWebhookEventDefinitions200ResponseInner(BaseModel):
    """
    ListWebhookEventDefinitions200ResponseInner
    """  # noqa: E501
    event_type: Optional[WebhookEventType] = None
    description: Optional[StrictStr] = Field(default=None, description="The description of the webhook event type.")
    __properties: ClassVar[List[str]] = ["event_type", "description"]
