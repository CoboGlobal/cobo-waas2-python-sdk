...
class AddressTransferDestination(BaseModel):
    ...
    change_output_type: Optional[StrictStr] = Field(default=None, description="The type of change output: **Last** means the change output is located at the end of the transaction's outputs, **Last** is the default value. while **First** means it is located at the beginning of the transaction's outputs. ")
