...
class TokenizationSolTokenPermissionParams(BaseModel):
    """
    ...
    """  # noqa: E501
    permanent_delegate: Optional[StrictStr] = Field(default=None, description="Solana wallet address that acts as a permanent delegate authority for the token. This authority can perform delegated operations on behalf of token holders.")
    minter: Optional[StrictStr] = Field(default=None, description="Solana wallet addres that acts as a minter authority for the token. This authority can mint new tokens.")
    ...
    __properties: ClassVar[List[str]] = ["permanent_delegate", "minter", "freezer", "updater", "pauser"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permanent_delegate": obj.get("permanent_delegate"),
