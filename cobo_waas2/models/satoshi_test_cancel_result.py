...
class SatoshiTestCancelResult(BaseModel):
    """
    Returned by [Cancel Satoshi Test challenge](#operation/cancel_satoshi_test_challenge).
    """  # noqa: E501
    challenge_id: StrictStr = Field(description="The challenge that was cancelled.")
    status: StrictStr = Field(description="Final status after cancellation.")
    __properties: ClassVar[List[str]] = ["challenge_id", "status"]
