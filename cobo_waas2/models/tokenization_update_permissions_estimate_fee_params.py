...
class TokenizationUpdatePermissionsEstimateFeeParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["source", "action", "address", "permissions", "operation_type", "token_id", "request_id"]
