...
class ListReconciliationStatements200Response(BaseModel):
    """
    ListReconciliationStatements200Response
    """  # noqa: E501
    data: List[ReconDailyStatement] = Field(description="The list of daily reconciliation statements.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ReconDailyStatement.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
