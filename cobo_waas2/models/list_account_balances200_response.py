...
class ListAccountBalances200Response(BaseModel):
    """
    ListAccountBalances200Response
    """  # noqa: E501
    data: Optional[List[BalanceAtBlock]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BalanceAtBlock.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
