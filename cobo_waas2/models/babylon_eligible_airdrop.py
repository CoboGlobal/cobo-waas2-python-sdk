...
class BabylonEligibleAirdrop(BaseModel):
    ...
    babylon_points: Optional[StrictStr] = Field(default=None, description="Current Babylon points balance")
    airdrop_amount: Optional[StrictStr] = Field(default=None, description="Airdrop amount based on current points")
