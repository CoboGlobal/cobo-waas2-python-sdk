...
class FiatTransactionEventData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["data_type", "transaction_id", "main_transaction_id", "transaction_type", "amount", "fiat_currency", "status", "cobo_category", "created_timestamp", "modified_timestamp"]
