...
class TransactionSigner(BaseModel):
    """
    The signer data for transaction.
    """  # noqa: E501
    signer: Optional[StrictStr] = Field(default=None, description="The signer name of the transaction.")
    status: Optional[StrictStr] = Field(default=None, description="The signing status.")
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Pending', 'Signed', 'Timeout', 'Rejected']):
            raise ValueError("must be one of enum values ('Pending', 'Signed', 'Timeout', 'Rejected')")
        return value
