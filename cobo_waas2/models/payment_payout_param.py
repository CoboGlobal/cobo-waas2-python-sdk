...
class PaymentPayoutParam(BaseModel):
    ...
    PaymentPayoutParam
    """  # noqa: E501
    merchant_id: Optional[StrictStr] = Field(default=None, description="Only used in Merchant source type. The merchant ID. ")
    ...
    __properties: ClassVar[List[str]] = ["merchant_id", "token_id", "amount", "crypto_address_id", "crypto_address"]
