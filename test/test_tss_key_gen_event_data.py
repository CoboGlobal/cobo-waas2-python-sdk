...
class TestTSSKeyGenEventData(unittest.TestCase):
    """TSSKeyGenEventData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TSSKeyGenEventData:
        """Test TSSKeyGenEventData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TSSKeyGenEventData`
        """
        model = TSSKeyGenEventData()
        if include_optional:
            return TSSKeyGenEventData(
                data_type = 'KeyGen',
                ...
                failed_reason = '',
                request_detail = cobo_waas2.models.tss_key_gen_request.TSSKeyGenRequest(
                    threshold = 2, 
                    node_ids = [
    ...
    def testTSSKeyGenEventData(self):
        """Test TSSKeyGenEventData"""
