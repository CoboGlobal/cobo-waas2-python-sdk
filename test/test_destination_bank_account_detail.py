...
class TestDestinationBankAccountDetail(unittest.TestCase):
    """DestinationBankAccountDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DestinationBankAccountDetail:
        """Test DestinationBankAccountDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationBankAccountDetail`
        """
        model = DestinationBankAccountDetail()
        if include_optional:
    ...
    def testDestinationBankAccountDetail(self):
        """Test DestinationBankAccountDetail"""
