...
class TestCreateDestinationBankAccount(unittest.TestCase):
    """CreateDestinationBankAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDestinationBankAccount:
        """Test CreateDestinationBankAccount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDestinationBankAccount`
        """
        model = CreateDestinationBankAccount()
        if include_optional:
            return CreateDestinationBankAccount(
    ...
    def testCreateDestinationBankAccount(self):
        """Test CreateDestinationBankAccount"""
