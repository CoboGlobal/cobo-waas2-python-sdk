...
class TestListTransactionApprovalDetails200Response(unittest.TestCase):
    """ListTransactionApprovalDetails200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTransactionApprovalDetails200Response:
        """Test ListTransactionApprovalDetails200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTransactionApprovalDetails200Response`
        """
        model = ListTransactionApprovalDetails200Response()
        if include_optional:
            return ListTransactionApprovalDetails200Response(
                data = [
                    cobo_waas2.models.transaction_approval_detail.TransactionApprovalDetail(
    ...
    def testListTransactionApprovalDetails200Response(self):
        """Test ListTransactionApprovalDetails200Response"""
