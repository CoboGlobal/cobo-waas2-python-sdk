...
class TestTSSKeyShareSignSignatures(unittest.TestCase):
    """TSSKeyShareSignSignatures unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TSSKeyShareSignSignatures:
        """Test TSSKeyShareSignSignatures
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TSSKeyShareSignSignatures`
        """
        model = TSSKeyShareSignSignatures()
        if include_optional:
            return TSSKeyShareSignSignatures(
                signatures = [
    ...
    def testTSSKeyShareSignSignatures(self):
        """Test TSSKeyShareSignSignatures"""
