...
class TestUpdateDestinationBankAccount(unittest.TestCase):
    """UpdateDestinationBankAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDestinationBankAccount:
        """Test UpdateDestinationBankAccount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDestinationBankAccount`
        """
        model = UpdateDestinationBankAccount()
        if include_optional:
    ...
    def testUpdateDestinationBankAccount(self):
        """Test UpdateDestinationBankAccount"""
