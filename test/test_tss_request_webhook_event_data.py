...
class TestTSSRequestWebhookEventData(unittest.TestCase):
    """TSSRequestWebhookEventData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TSSRequestWebhookEventData:
        """Test TSSRequestWebhookEventData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TSSRequestWebhookEventData`
        """
        model = TSSRequestWebhookEventData()
        if include_optional:
            return TSSRequestWebhookEventData(
    ...
    def testTSSRequestWebhookEventData(self):
        """Test TSSRequestWebhookEventData"""
