...
class TestTokenizationSOLTokenParams(unittest.TestCase):
    """TokenizationSOLTokenParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TokenizationSOLTokenParams:
        """Test TokenizationSOLTokenParams
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TokenizationSOLTokenParams`
        """
        model = TokenizationSOLTokenParams()
        if include_optional:
            return TokenizationSOLTokenParams(
                standard = 'ERC20',
    ...
    def testTokenizationSOLTokenParams(self):
        """Test TokenizationSOLTokenParams"""
