...
class TestTSSEventData(unittest.TestCase):
    """TSSEventData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TSSEventData:
        """Test TSSEventData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TSSEventData`
        """
        model = TSSEventData()
        if include_optional:
            return TSSEventData(
