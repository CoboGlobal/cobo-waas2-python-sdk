...
class TestTransactionReceipt(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransactionReceipt:
        """Test TransactionReceipt
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionReceipt`
        """
        ...
        if include_optional:
            return TransactionReceipt(
                ...
                logs = [
                    cobo_waas2.models.transaction_receipt_log.TransactionReceiptLog(
                        log_index = 5, 
