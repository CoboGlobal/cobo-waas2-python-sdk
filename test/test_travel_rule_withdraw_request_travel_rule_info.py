...
class TestTravelRuleWithdrawRequestTravelRuleInfo(unittest.TestCase):
    """TravelRuleWithdrawRequestTravelRuleInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelRuleWithdrawRequestTravelRuleInfo:
        """Test TravelRuleWithdrawRequestTravelRuleInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelRuleWithdrawRequestTravelRuleInfo`
        """
        model = TravelRuleWithdrawRequestTravelRuleInfo()
        if include_optional:
    ...
    def testTravelRuleWithdrawRequestTravelRuleInfo(self):
        """Test TravelRuleWithdrawRequestTravelRuleInfo"""
