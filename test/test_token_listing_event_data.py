...
class TestTokenListingEventData(unittest.TestCase):
    """TokenListingEventData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TokenListingEventData:
        """Test TokenListingEventData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TokenListingEventData`
        """
        model = TokenListingEventData()
        if include_optional:
    ...
    def testTokenListingEventData(self):
        """Test TokenListingEventData"""
