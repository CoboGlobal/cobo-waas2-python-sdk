...
class TestDestinationDetail(unittest.TestCase):
    """DestinationDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DestinationDetail:
        """Test DestinationDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationDetail`
        """
    ...
    def testDestinationDetail(self):
        """Test DestinationDetail"""
