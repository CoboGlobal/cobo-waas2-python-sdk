...
class TestTransactionUserApprovalDetail(unittest.TestCase):
    """TransactionUserApprovalDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionUserApprovalDetail:
        """Test TransactionUserApprovalDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionUserApprovalDetail`
        """
    ...
    def testTransactionUserApprovalDetail(self):
        """Test TransactionUserApprovalDetail"""
