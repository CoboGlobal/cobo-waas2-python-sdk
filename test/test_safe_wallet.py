...
class TestSafeWallet(unittest.TestCase):
    """SafeWallet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SafeWallet:
        """Test SafeWallet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SafeWallet`
        """
        model = SafeWallet()
        if include_optional:
            return SafeWallet(
