...
class TestPaymentSubscriptionAction(unittest.TestCase):
    """PaymentSubscriptionAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentSubscriptionAction:
        """Test PaymentSubscriptionAction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentSubscriptionAction`
        """
        model = PaymentSubscriptionAction()
        if include_optional:
    ...
    def testPaymentSubscriptionAction(self):
        """Test PaymentSubscriptionAction"""
