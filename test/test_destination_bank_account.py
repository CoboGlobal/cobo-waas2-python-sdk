...
class TestDestinationBankAccount(unittest.TestCase):
    """DestinationBankAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DestinationBankAccount:
        """Test DestinationBankAccount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationBankAccount`
        """
        model = DestinationBankAccount()
        if include_optional:
    ...
    def testDestinationBankAccount(self):
        """Test DestinationBankAccount"""
