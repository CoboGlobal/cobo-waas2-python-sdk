...
class TestTokenizationTokenPermissionParams(unittest.TestCase):
    """TokenizationTokenPermissionParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TokenizationTokenPermissionParams:
        """Test TokenizationTokenPermissionParams
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TokenizationTokenPermissionParams`
        """
        model = TokenizationTokenPermissionParams()
        if include_optional:
            return TokenizationTokenPermissionParams(
    ...
    def testTokenizationTokenPermissionParams(self):
        """Test TokenizationTokenPermissionParams"""
