...
class TestTransactionWebhookEventData(unittest.TestCase):
    """TransactionWebhookEventData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionWebhookEventData:
        """Test TransactionWebhookEventData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionWebhookEventData`
        """
        model = TransactionWebhookEventData()
        if include_optional:
            return TransactionWebhookEventData(
    ...
    def testTransactionWebhookEventData(self):
        """Test TransactionWebhookEventData"""
