...
class TestTokenListing(unittest.TestCase):
    """TokenListing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TokenListing:
        """Test TokenListing
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TokenListing`
        """
        model = TokenListing()
        if include_optional:
            return TokenListing(
