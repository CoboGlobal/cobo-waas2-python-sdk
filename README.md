...
*OAuthApi* | [**get_token**](docs/OAuthApi.md#get_token) | **GET** /oauth/token | Get access token
*OAuthApi* | [**refresh_token**](docs/OAuthApi.md#refresh_token) | **POST** /oauth/token | Refresh access token
...
*WalletsApi* | [**check_loop_transfers**](docs/WalletsApi.md#check_loop_transfers) | **GET** /wallets/check_loop_transfers | Check Loop transfers
...
*WalletsExchangeWalletApi* | [**list_exchanges**](docs/WalletsExchangeWalletApi.md#list_exchanges) | **GET** /wallets/exchanges/settings | List supported exchanges
