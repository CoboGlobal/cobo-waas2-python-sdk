...
*PaymentApi* | [**get_payer_balance_by_address**](docs/PaymentApi.md#get_payer_balance_by_address) | **GET** /payments/balance/payer/address | Get payer balance by address
