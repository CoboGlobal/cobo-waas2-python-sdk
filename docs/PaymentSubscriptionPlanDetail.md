...
**charge_amount** | **str** | The subscription plan crypto amount with input token_id.  | [optional] 
**contract_address** | **str** | The subscription contract address in cobo. | [optional] 
