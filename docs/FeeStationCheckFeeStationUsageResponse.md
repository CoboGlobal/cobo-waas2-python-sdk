...
**is_sponsor_applicable** | **bool** | Indicates whether USD stablecoin sponsorship is applied when the Fee Station balance is insufficient. | 
**sponsored_fee_amount** | **str** | The amount of gas fee sponsored by USD stablecoin when applicable. | 
