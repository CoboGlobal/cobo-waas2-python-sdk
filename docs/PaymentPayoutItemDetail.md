...
**token_id** | **str** | The token id of the payout. | [optional] 
**chain_id** | **str** | The ID of the blockchain network on which the payout occurred. | [optional] 
**merchant_id** | **str** | The Merchant ID associated with this payout. | [optional] 
**amount** | **str** | The payout token_id amount.  | 
