...
**bank_account_id** | **str** | The bank account ID, which you can retrieve by calling [List counterparty entries](https://www.cobo.com/developers/v2/api-references/payment/list-counterparty-entries).  | [optional] 
