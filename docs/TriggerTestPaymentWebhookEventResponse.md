...
trigger_test_payment_webhook_event_response_instance = TriggerTestPaymentWebhookEventResponse.from_json(json)
# print the JSON string representation of the object
print(TriggerTestPaymentWebhookEventResponse.to_json())

# convert the object into a dict
trigger_test_payment_webhook_event_response_dict = trigger_test_payment_webhook_event_response_instance.to_dict()
# create an instance of TriggerTestPaymentWebhookEventResponse from a dict
trigger_test_payment_webhook_event_response_from_dict = TriggerTestPaymentWebhookEventResponse.from_dict(trigger_test_payment_webhook_event_response_dict)
```
