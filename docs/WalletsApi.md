...
[**get_max_transferable_value_with_fee_model**](WalletsApi.md#get_max_transferable_value_with_fee_model) | **POST** /wallets/{wallet_id}/max_transferable_value_with_fee_model | Get maximum transferable value with fee model
...
------------- | ------------- | ------------- | -------------
 **wallet_id** | **str**| The wallet ID. | 
 **get_max_transferable_value_with_fee_model_request** | [**GetMaxTransferableValueWithFeeModelRequest**](GetMaxTransferableValueWithFeeModelRequest.md)| The request body to get max transferable value within a specified wallet. | [optional] 
