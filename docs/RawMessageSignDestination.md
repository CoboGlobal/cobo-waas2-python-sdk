...
[Deprecated] Due to security concerns, `Raw_Message_Signature` is no longer allowed and must not be used. Refer to [Transaction sources and destinations](https://www.cobo.com/developers/v2/guides/transactions/sources-and-destinations) for details.
