...
json = "{}"
# create an instance of ComplianceKyaScreeningsUpdateEventData from a JSON string
compliance_kya_screenings_update_event_data_instance = ComplianceKyaScreeningsUpdateEventData.from_json(json)
# print the JSON string representation of the object
print(ComplianceKyaScreeningsUpdateEventData.to_json())

# convert the object into a dict
compliance_kya_screenings_update_event_data_dict = compliance_kya_screenings_update_event_data_instance.to_dict()
# create an instance of ComplianceKyaScreeningsUpdateEventData from a dict
compliance_kya_screenings_update_event_data_from_dict = ComplianceKyaScreeningsUpdateEventData.from_dict(compliance_kya_screenings_update_event_data_dict)
```
