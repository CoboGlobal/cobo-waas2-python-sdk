...
**decimals** | **int** | The number of decimals for the token (0-18). | [optional] 
...
tokenization_erc20_fund_token_params_instance = TokenizationERC20FundTokenParams.from_json(json)
# print the JSON string representation of the object
print(TokenizationERC20FundTokenParams.to_json())

# convert the object into a dict
tokenization_erc20_fund_token_params_dict = tokenization_erc20_fund_token_params_instance.to_dict()
# create an instance of TokenizationERC20FundTokenParams from a dict
tokenization_erc20_fund_token_params_from_dict = TokenizationERC20FundTokenParams.from_dict(tokenization_erc20_fund_token_params_dict)
```
