...
**initiator** | **str** | Transaction initiator | [optional] 
**initiator_type** | [**TransactionInitiatorType**](TransactionInitiatorType.md) |  | 
**confirmed_num** | **int** | Transaction confirmed number | [optional] 
**confirming_threshold** | **int** | Number of confirmations required for a transaction, such as 15 for ETH chain. | [optional] 
...
**nonce** | **int** | Transaction nonce | [optional] 
**replaced_by** | **str** | Replace by transaction hash | [optional] 
**fueled_by** | **str** | Fueled by address | [optional] 
**token_approval** | [**TransactionTokeApproval**](TransactionTokeApproval.md) |  | [optional] 
**message** | **str** | Transaction raw message | [optional] 
**algorithm** | **str** | Transaction message signing algorithm | [optional] 
