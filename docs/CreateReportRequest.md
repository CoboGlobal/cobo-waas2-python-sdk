...
------------ | ------------- | ------------- | -------------
**start_time** | **int** | The start time of the report. Unix timestamp. | 
**end_time** | **int** | The end time of the report. Unix timestamp. | 
**report_export_format** | [**ReportExportFormat**](ReportExportFormat.md) |  | 
**report_types** | [**List[ReportType]**](ReportType.md) |  | 
**token_ids** | **List[str]** | The token IDs of the report. | [optional] 
